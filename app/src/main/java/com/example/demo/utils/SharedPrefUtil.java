...
public final class SharedPrefUtil {
    ...
    public static final String MINE_PERF = "Demo";
    ...
    private static SharedPreferences getSharedPreferences(Context context) {
        SharedPreferences pref = context.getSharedPreferences(SharedPrefUtil.MINE_PERF, Context.MODE_PRIVATE);
        return pref;
    }

    public static void clearSharedPreferences(Context mContext){
        SharedPreferences pref = mContext.getSharedPreferences(SharedPrefUtil.MINE_PERF, Context.MODE_PRIVATE);
